# Polyhydra - Fund15 Proposal Draft v2
...
- Access to 3 gaming Discord servers (2,000+ members)
...
- **Smart Contract Dev:** 18,000 ADA / $7,560 (24%) - Hydra manager, Aiken contracts, VRF logic
- **Game Development:** 22,000 ADA / $9,240 (29%) - Phaser client, Colyseus server, mechanics
- **Frontend & Integration:** 15,000 ADA / $6,300 (20%) - React UI, Discord Activity, wallet integration
...
- **Documentation:** 4,000 ADA / $1,680 (5%) - Technical docs, user guides, close-out video
- **Contingency:** 3,000 ADA / $1,260 (4%) - Unexpected costs, scope adjustments
...
- [x] Problem statement under 200 characters (193)
- [x] Solution overview under 200 characters (184)
...
- [x] MVP/Prototype described with technical architecture
...
- [x] Latency targets specified (<200ms)
- [x] VRF mechanism explained
